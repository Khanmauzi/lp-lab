...
{
	if(maintable[index]==value) return true;  // Check Properly for datatype
	return false;
...
union YYSTYPE
{
#line 80 "compile.y" /* yacc.c:355  */

int number;
char* str;

#line 217 "compile.tab.c" /* yacc.c:355  */
};
...
#line 234 "compile.tab.c" /* yacc.c:358  */
...
{
       0,   114,   114,   117,   128,   131,   134,   137,   139,   144,
     156,   167,   179,   186,   194,   201,   209,   216,   225,   236,
     244,   252,   260,   268,   278,   291,   303,   315,   331,   343,
     354,   366,   378,   390,   398,   406,   414,   422,   430,   439,
     447,   455,   463,   468,   474,   481,   488
};
#endif
...
static const char *const yytname[] =
{
  ...
  "LAND", "'|'", "'^'", "'&'", "'~'", "'='", "'+'", "'-'", "'*'", "'/'",
  "'%'", "'{'", "'}'", "'('", "')'", "';'", "$accept", "StartSymbol",
  "statements", "IfStatement", "WhileStatement", "DeclareStatement",
  "AssignmentStatement", "expression", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 114 "compile.y" /* yacc.c:1646  */
    {
								(yyval.number)=getEmptyRow();		
							}
#line 1445 "compile.tab.c" /* yacc.c:1646  */
    break;
...
#line 117 "compile.y" /* yacc.c:1646  */
    {
 								(yyval.number)=getEmptyRow();
 								if(lastTableIndex!=-1)
 								table[(yyval.number)].code=table[lastTableIndex].code+table[(yyvsp[0].number)].code;
 								else
 								table[(yyval.number)].code=table[(yyvsp[0].number)].code;
 								maini = (yyval.number);
 								lastTableIndex=(yyval.number);
 							}
#line 1459 "compile.tab.c" /* yacc.c:1646  */
    break;
...
#line 1467 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 5:
#line 131 "compile.y" /* yacc.c:1646  */
    {(yyval.number) = (yyvsp[0].number);
							}
#line 1474 "compile.tab.c" /* yacc.c:1646  */
    break;
...
#line 1481 "compile.tab.c" /* yacc.c:1646  */
    break;
...
#line 1488 "compile.tab.c" /* yacc.c:1646  */
    break;
...
#line 1497 "compile.tab.c" /* yacc.c:1646  */
  ...
  case 9:
#line 144 "compile.y" /* yacc.c:1646  */
    {
								    if(!conditionformaintable(table[(yyvsp[-2].number)].place,"BOOL"))	{
...
#line 1514 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 156 "compile.y" /* yacc.c:1646  */
    {
  									if(!conditionformaintable(table[(yyvsp[-4].number)].place,"BOOL"))	exit(0);
									(yyval.number)=getEmptyRow();
									table[(yyval.number)].after=getLabel();
									string gen="";
...
#line 1528 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 167 "compile.y" /* yacc.c:1646  */
    {
									if(!conditionformaintable(table[(yyvsp[-2].number)].place,"BOOL"))	exit(0);
									(yyval.number)=getEmptyRow();
									table[(yyval.number)].initial=getLabel();
									table[(yyval.number)].after=getLabel();
									string gen="";
									gen=table[(yyval.number)].initial+":\n"+"if "+table[(yyvsp[-2].number)].place+"=="+'0'+" goto "+table[(yyval.number)].after+'\n';
									table[(yyval.number)].code=table[(yyvsp[-2].number)].code+gen+table[(yyvsp[0].number)].code+'\n'+"goto " +table[(yyval.number)].initial+"\n"+table[(yyval.number)].after+":";
									maini==(yyval.number);
							}
#line 1543 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 179 "compile.y" /* yacc.c:1646  */
    {
							if(maintable.find(string((yyvsp[-1].str)))!=maintable.end()){cout<<"redeclaration of "<<(yyvsp[-1].str)<<endl; exit(0);}
							maintable[string((yyvsp[-1].str))] = "INT";
							(yyval.number) =getEmptyRow();
...
#line 1555 "compile.tab.c" /* yacc.c:1646  */
  ...
  case 13:
#line 186 "compile.y" /* yacc.c:1646  */
    {
    						if(maintable.find(string((yyvsp[-3].str)))!=maintable.end()) {cout<<"redeclaration of "<<(yyvsp[-3].str)<<endl; exit(0);}
    						maintable[string((yyvsp[-3].str))] = "INT";
    						(yyval.number) =getEmptyRow();
							string mycode  = string((yyvsp[-3].str))+ '=' + table[(yyvsp[-1].number)].place + '\n';
							table[(yyval.number)].code=table[(yyvsp[-1].number)].code+"\n"+mycode;
							maini=(yyval.number);
    				    }
#line 1568 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 194 "compile.y" /* yacc.c:1646  */
    {
    						if(maintable.find(string((yyvsp[-1].str)))!=maintable.end()) exit(0);
	 						maintable[string((yyvsp[-1].str))] = "UINT";
	 						(yyval.number) =getEmptyRow();
							table[(yyval.number)].code ="Declaring "+string((yyvsp[-1].str))+"\n";
							maini=(yyval.number);
     		            }
#line 1580 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 15:
#line 201 "compile.y" /* yacc.c:1646  */
    {
    						if(maintable.find(string((yyvsp[-3].str)))!=maintable.end()) exit(0);
							        					maintable[string((yyvsp[-3].str))] = "UINT";
    						(yyval.number) =getEmptyRow();
							string mycode  = string((yyvsp[-3].str))+ '=' + table[(yyvsp[-1].number)].place + '\n';
							table[(yyval.number)].code=table[(yyvsp[-1].number)].code+"\n"+mycode;
							maini=(yyval.number);
    				    }
#line 1593 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 16:
#line 209 "compile.y" /* yacc.c:1646  */
    {
                            if(maintable.find(string((yyvsp[-1].str)))!=maintable.end()) exit(0);
	 						maintable[string((yyvsp[-1].str))] = "BOOL";
	 						(yyval.number) =getEmptyRow();
							table[(yyval.number)].code ="Declaring "+string((yyvsp[-1].str))+"\n";
							maini=(yyval.number);
   						}
...
#line 216 "compile.y" /* yacc.c:1646  */
    {
                            if(maintable.find(string((yyvsp[-3].str)))!=maintable.end()) { exit(0);}
	 						...
	 						maintable[string((yyvsp[-3].str))] = "BOOL";
	 						(yyval.number) =getEmptyRow();
...
#line 1633 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 19:
#line 236 "compile.y" /* yacc.c:1646  */
    {
					if(maintable.find(string((yyvsp[-3].str)))==maintable.end()){cout<<(yyvsp[-3].str)<<" is not declared"<<endl; exit(0);}
					checkcompati(table[(yyvsp[-1].number)].place,table[(yyvsp[-1].number)].place);
					(yyval.number) =getEmptyRow();
					string mycode  = string((yyvsp[-3].str))+ '=' + table[(yyvsp[-1].number)].place + '\n';
...
#line 244 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					checkcompati(table[(yyvsp[-1].number)].place,table[(yyvsp[-1].number)].place);
					maintable[table[(yyval.number)].place] ="INT";
...
#line 1659 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 21:
#line 252 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					checkcompati(table[(yyvsp[-1].number)].place,table[(yyvsp[-1].number)].place);
...
#line 1672 "compile.tab.c" /* yacc.c:1646  */
  ...
  case 22:
#line 260 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					checkcompati(table[(yyvsp[-1].number)].place,table[(yyvsp[-1].number)].place);
...
#line 1685 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 268 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					checkcompati(table[(yyvsp[-1].number)].place,table[(yyvsp[-1].number)].place);
...
#line 1698 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 24:
#line 278 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					checkcompati(table[(yyvsp[0].number)].place,table[(yyvsp[0].number)].place);
					if(conditionformaintable(table[(yyvsp[-2].number)].place,"BOOL") || conditionformaintable(table[(yyvsp[0].number)].place, "BOOL"))exit(0);
					
					if(maintable[table[(yyvsp[0].number)].place] =="INT"||maintable[table[(yyvsp[-2].number)].place] =="INT")
					maintable[table[(yyval.number)].place] ="INT";
					else
					maintable[table[(yyval.number)].place] ="UINT";
...
#line 1716 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 25:
#line 291 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					checkcompati(table[(yyvsp[0].number)].place,table[(yyvsp[0].number)].place);
...
#line 1733 "compile.tab.c" /* yacc.c:1646  */
  ...
  case 26:
#line 303 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					checkcompati(table[(yyvsp[0].number)].place,table[(yyvsp[0].number)].place);
...
#line 1750 "compile.tab.c" /* yacc.c:1646  */
    break;
...
#line 315 "compile.y" /* yacc.c:1646  */
    {
	  				(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					if(maintable[table[(yyvsp[0].number)].place]=="BOOL") exit(0);
					if(maintable[table[(yyvsp[0].number)].place]=="INT")
					{
						maintable[table[(yyval.number)].place] ="INT";
					}
					else
...
#line 1771 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 28:
#line 331 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					checkcompati(table[(yyvsp[0].number)].place,table[(yyvsp[0].number)].place);
...
#line 343 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					if(!compati(maintable[table[(yyvsp[0].number)].place],maintable[table[(yyvsp[0].number)].place])) exit(0);
					if(maintable[table[(yyvsp[0].number)].place] =="INT"||maintable[table[(yyvsp[-2].number)].place] =="INT")
					maintable[table[(yyval.number)].place] ="INT";
					else
					maintable[table[(yyval.number)].place] ="UINT";
...
#line 1804 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 30:
#line 354 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					checkcompati(table[(yyvsp[0].number)].place,table[(yyvsp[0].number)].place);
...
#line 1821 "compile.tab.c" /* yacc.c:1646  */
    break;
...
#line 1838 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 32:
#line 378 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					checkcompati(table[(yyvsp[0].number)].place,table[(yyvsp[0].number)].place);
...
#line 1855 "compile.tab.c" /* yacc.c:1646  */
  ...
  case 33:
#line 390 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts(); 
					if(maintable[table[(yyvsp[-2].number)].place] !="BOOL"||maintable[table[(yyvsp[0].number)].place] !="BOOL") exit(0);
					table[(yyval.number)].code = table[(yyvsp[-2].number)].code+table[(yyvsp[0].number)].code +table[(yyval.number)].place + '=' +table[(yyvsp[-2].number)].place + "||" + table[(yyvsp[0].number)].place+"\n";
					maintable[table[(yyval.number)].place] ="BOOL";
					maini=(yyval.number);
			      }
#line 1868 "compile.tab.c" /* yacc.c:1646  */
    break;
...
#line 1881 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 35:
#line 406 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					if(maintable[table[(yyvsp[-2].number)].place] =="BOOL"||maintable[table[(yyvsp[0].number)].place] =="BOOL") exit(0);
...
#line 1894 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 36:
#line 414 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					if(maintable[table[(yyvsp[-2].number)].place] =="BOOL"||maintable[table[(yyvsp[0].number)].place] =="BOOL") exit(0);
...
#line 1907 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 37:
#line 422 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					if(maintable[table[(yyvsp[-2].number)].place] =="BOOL"||maintable[table[(yyvsp[0].number)].place] =="BOOL") exit(0);
...
#line 1920 "compile.tab.c" /* yacc.c:1646  */
  ...
  case 38:
#line 430 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					if(maintable[table[(yyvsp[-2].number)].place] =="BOOL"||maintable[table[(yyvsp[0].number)].place] =="BOOL") exit(0);
...
#line 1933 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 39:
#line 439 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =nts();
					if(maintable[table[(yyvsp[-2].number)].place] =="BOOL"||maintable[table[(yyvsp[0].number)].place] =="BOOL") exit(0);
...
#line 1946 "compile.tab.c" /* yacc.c:1646  */
    break;
...
#line 1959 "compile.tab.c" /* yacc.c:1646  */
    break;
...
#line 1972 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 42:
#line 463 "compile.y" /* yacc.c:1646  */
    {
					(yyval.number) = getEmptyRow();
					table[(yyval.number)] = table[(yyvsp[-1].number)];
					maini = (yyval.number);
				  }
#line 1982 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 43:
#line 468 "compile.y" /* yacc.c:1646  */
    {
	                if(maintable.find(string((yyvsp[0].str)))==maintable.end()) exit(0);
	    			(yyval.number) =getEmptyRow();
					table[(yyval.number)].place =string((yyvsp[0].str));
					maini=(yyval.number);
				  }
#line 1993 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 44:
#line 474 "compile.y" /* yacc.c:1646  */
    {
	    			(yyval.number) = getEmptyRow();
					table[(yyval.number)].place = nts();
					maintable[table[(yyval.number)].place]="BOOL";
...
#line 2005 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 45:
#line 481 "compile.y" /* yacc.c:1646  */
    {
	    			(yyval.number) = getEmptyRow();
					table[(yyval.number)].place = nts();
					maintable[table[(yyval.number)].place]="BOOL";
...
#line 2017 "compile.tab.c" /* yacc.c:1646  */
    break;

  case 46:
#line 488 "compile.y" /* yacc.c:1646  */
    {
						(yyval.number) = getEmptyRow();
						table[(yyval.number)].place = nts();
						maintable[table[(yyval.number)].place]="INT";
...
#line 2029 "compile.tab.c" /* yacc.c:1646  */
    break;


#line 2033 "compile.tab.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 496 "compile.y" /* yacc.c:1906  */
